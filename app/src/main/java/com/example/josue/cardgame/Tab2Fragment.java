...
public class Tab2Fragment extends Fragment {
    ...
    public static final String TITLE = "6x6";
...
//
//        TextView highscoreLabel = (TextView) findViewById(R.id.highscoreLabel2);
//        TextView highScores = (TextView) findViewById(R.id.highScores2);
//
...
//        try {
//            ois = new ObjectInputStream(new FileInputStream("assets/highscore2.txt"));
